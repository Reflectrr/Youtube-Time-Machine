...
import SwiperStacking from "./SwiperStacking";

const SubsectionRowStacking = ({ channel }) => {
  ...
  return (
    <React.Fragment>
      ...
      {videos && <SwiperStacking channel={channel} videos={videos}></SwiperStacking>}
    </React.Fragment>
  );
};

export default SubsectionRowStacking;
